...
const SymptomChecker = () => {
  ...
  const commonSymptoms = [
    ...
    { name: "Acne", icon: <Activity className="h-4 w-4" /> },
    { name: "Allergy", icon: <Activity className="h-4 w-4" /> },
    { name: "Alzheimer's", icon: <Activity className="h-4 w-4" /> },
    { name: "Anemia", icon: <Activity className="h-4 w-4" /> },
    { name: "Arthritis", icon: <Activity className="h-4 w-4" /> },
    { name: "Asthma", icon: <Activity className="h-4 w-4" /> },
    { name: "Back Pain", icon: <Activity className="h-4 w-4" /> },
    { name: "Bronchitis", icon: <Activity className="h-4 w-4" /> },
    { name: "Breast Cancer", icon: <Activity className="h-4 w-4" /> },
    { name: "Cataracts", icon: <Activity className="h-4 w-4" /> },
    { name: "Chlamydia", icon: <Activity className="h-4 w-4" /> },
    { name: "Chickenpox", icon: <Activity className="h-4 w-4" /> },
    { name: "Cholera", icon: <Activity className="h-4 w-4" /> },
    {
      name: "Chronic Fatigue Syndrome",
      icon: <Activity className="h-4 w-4" />,
    },
    { name: "Colorectal Cancer", icon: <Activity className="h-4 w-4" /> },
    { name: "Common Cold", icon: <Activity className="h-4 w-4" /> },
    { name: "Conjunctivitis", icon: <Activity className="h-4 w-4" /> },
    { name: "COVID-19", icon: <Activity className="h-4 w-4" /> },
    { name: "Dengue", icon: <Activity className="h-4 w-4" /> },
    { name: "Diabetes", icon: <Activity className="h-4 w-4" /> },
    { name: "Ear Infection", icon: <Activity className="h-4 w-4" /> },
    { name: "Eczema", icon: <Activity className="h-4 w-4" /> },
    { name: "Epilepsy", icon: <Activity className="h-4 w-4" /> },
    { name: "Eye Infection", icon: <Activity className="h-4 w-4" /> },
    { name: "Fibromyalgia", icon: <Activity className="h-4 w-4" /> },
    { name: "Flu", icon: <Activity className="h-4 w-4" /> },
    { name: "Gastritis", icon: <Activity className="h-4 w-4" /> },
    { name: "Glaucoma", icon: <Activity className="h-4 w-4" /> },
    { name: "Gonorrhea", icon: <Activity className="h-4 w-4" /> },
    { name: "Gout", icon: <Activity className="h-4 w-4" /> },
    { name: "Heart Disease", icon: <Heart className="h-4 w-4" /> },
    { name: "Hepatitis", icon: <Activity className="h-4 w-4" /> },
    { name: "Hepatitis B", icon: <Activity className="h-4 w-4" /> },
    { name: "Hepatitis C", icon: <Activity className="h-4 w-4" /> },
    { name: "HIV", icon: <Activity className="h-4 w-4" /> },
    { name: "Hyperthyroidism", icon: <Activity className="h-4 w-4" /> },
    { name: "Hypertension", icon: <Activity className="h-4 w-4" /> },
    { name: "Hypothyroidism", icon: <Activity className="h-4 w-4" /> },
    { name: "Indigestion", icon: <Activity className="h-4 w-4" /> },
    { name: "Influenza", icon: <Activity className="h-4 w-4" /> },
    {
      name: "Irritable Bowel Syndrome (IBS)",
      icon: <Activity className="h-4 w-4" />,
    },
    { name: "Kidney Disease", icon: <Activity className="h-4 w-4" /> },
    { name: "Leukemia", icon: <Activity className="h-4 w-4" /> },
    { name: "Lupus", icon: <Activity className="h-4 w-4" /> },
    { name: "Lyme Disease", icon: <Activity className="h-4 w-4" /> },
    { name: "Malaria", icon: <Activity className="h-4 w-4" /> },
    { name: "Melanoma", icon: <Activity className="h-4 w-4" /> },
    { name: "Migraine", icon: <Zap className="h-4 w-4" /> },
    { name: "Multiple Sclerosis", icon: <Activity className="h-4 w-4" /> },
    { name: "Obesity", icon: <Activity className="h-4 w-4" /> },
    { name: "Osteoporosis", icon: <Activity className="h-4 w-4" /> },
    { name: "Otitis Media", icon: <Activity className="h-4 w-4" /> },
    { name: "Ovarian Cancer", icon: <Activity className="h-4 w-4" /> },
    { name: "Pancreatic Cancer", icon: <Activity className="h-4 w-4" /> },
    { name: "Parkinson's", icon: <Activity className="h-4 w-4" /> },
    { name: "Peptic Ulcer", icon: <Activity className="h-4 w-4" /> },
    { name: "Pneumonia", icon: <Activity className="h-4 w-4" /> },
    { name: "Prostate Cancer", icon: <Activity className="h-4 w-4" /> },
    { name: "Psoriasis", icon: <Activity className="h-4 w-4" /> },
    { name: "Rheumatoid Arthritis", icon: <Activity className="h-4 w-4" /> },
    { name: "Schizophrenia", icon: <Activity className="h-4 w-4" /> },
    { name: "Shingles", icon: <Activity className="h-4 w-4" /> },
    { name: "Sinusitis", icon: <Activity className="h-4 w-4" /> },
    { name: "Syphilis", icon: <Activity className="h-4 w-4" /> },
    { name: "Tetanus", icon: <Activity className="h-4 w-4" /> },
    { name: "Tuberculosis", icon: <Activity className="h-4 w-4" /> },
    { name: "Typhoid", icon: <Activity className="h-4 w-4" /> },
    { name: "Whooping Cough", icon: <Activity className="h-4 w-4" /> },
    { name: "Yellow Fever", icon: <Activity className="h-4 w-4" /> },
  ];
